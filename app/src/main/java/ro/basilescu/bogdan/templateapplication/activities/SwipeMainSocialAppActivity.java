...
public class SwipeMainSocialAppActivity extends AppCompatActivity implements FirebaseFragment.OnFragmentFirebaseListener,
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user == null) {
                    ...
                    startActivity(new Intent(SwipeMainSocialAppActivity.this, LoginActivity.class));
                    finish();
                }
            }
        };

        setContentView(R.layout.activity_swipe_social_app_main);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.profile:
                Intent intent = new Intent(SwipeMainSocialAppActivity.this, ProfileActivity.class);
