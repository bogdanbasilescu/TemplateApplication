 ...
 * {@link OnFragmentFirebaseListener} interface
...
public class FirebaseFragment extends Fragment {
    ...
    private OnFragmentFirebaseListener mListener;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnFragmentFirebaseListener) {
            mListener = (OnFragmentFirebaseListener) context;
        } else {
     ...
     */
    public interface OnFragmentFirebaseListener {
        // TODO: Update argument type and name
        void onFragmentFirebaseInteraction(String firebaseEvent);
    }
}
